...
def main():
   ...
   graph.add_node("B21", 540, 516)
   graph.add_node("B18", 590, 444)
   graph.add_node("B11", 593, 380)
   graph.add_node("P6B", 607, 345)
   graph.add_node("B51", 447, 481)
   graph.add_node("BaseballField", 497, 457)
   graph.add_node("B47", 565, 397)
   graph.add_node("B16", 542, 416)
   graph.add_node("B15", 519, 401)
   graph.add_node("B10", 559, 352)
   graph.add_node("B12A", 523, 348)
   graph.add_node("B12B", 582, 340)
   graph.add_node("Unlisted", 455, 314)
   graph.add_node("B13", 462, 415)
   graph.add_node("B14", 472, 356)
   graph.add_node("SouthernRoadway0", 490, 562)
   graph.add_node("B46A", 357, 610)
   graph.add_node("B46B", 302, 611)
   graph.add_node("B46C", 330, 657)
   graph.add_node("B46D", 270, 615)
   graph.add_node("B46E", 219, 624)
   graph.add_node("B46F", 292, 686)
   graph.add_node("B46G", 228, 667)
   graph.add_node("MainCourtyardsBuilding", 359, 647)
   graph.add_node("LeaseOffice", 287, 653)
   graph.add_node("SouthernRoadway1", 153, 610)
   graph.add_node("B54", 75, 578)
   ...
   graph.add_edge("B21", "HealthServices")
   graph.add_edge("P9", "B18")
   graph.add_edge("B11", "Conwell")
   graph.add_edge("B11", "B18")
   graph.add_edge("B11", "Conrad")
   graph.add_edge("P6B", "B11")
   graph.add_edge("P6B", "Conwell")
   graph.add_edge("P6B", "B8")
   graph.add_edge("Conwell", "B7")
   graph.add_edge("B7", "Gym")
   graph.add_edge("P8A", "Conwell")
   graph.add_edge("P16", "E&H")
   graph.add_edge("P19", "E&H")
   graph.add_edge("B42", "P24")
   graph.add_edge("P16", "DEPublicMedia")
   graph.add_edge("B51", "B21")
   graph.add_edge("B51", "BaseballField")
   graph.add_edge("B21", "BaseballField")
   graph.add_edge("B18", "BaseballField")
   graph.add_edge("B47", "B11")
   graph.add_edge("B47", "B18")
   graph.add_edge("B16", "B47")
   graph.add_edge("B16", "BaseballField")
   graph.add_edge("B16", "B18")
   graph.add_edge("P9", "BaseballField")
   graph.add_edge("B15", "BaseballField")
   graph.add_edge("B15", "B16")
   graph.add_edge("B15", "B47")
   graph.add_edge("B10", "P6B")
   graph.add_edge("B10", "B11")
   graph.add_edge("B10", "B47")
   graph.add_edge("B10", "B15")
   graph.add_edge("B12A", "B10")
   graph.add_edge("B12A", "B15")
   graph.add_edge("B12B", "P6B")
   graph.add_edge("B12B", "B10")
   graph.add_edge("Unlisted", "B14")
   graph.add_edge("Unlisted", "B12A")
   graph.add_edge("B14", "B12A")
   graph.add_edge("B13", "B14")
   graph.add_edge("B13", "B15")
   graph.add_edge("B13", "BaseballField")
   graph.add_edge("B13", "B51")
   graph.add_edge("SouthernRoadway0", "HealthServices")
   graph.add_edge("SouthernRoadway0", "B21")
   graph.add_edge("SouthernRoadway0", "DEPublicMedia")
   graph.add_edge("SouthernRoadway0", "B46A")
   graph.add_edge("B46A", "B46B")
   graph.add_edge("B46A", "B46C")
   graph.add_edge("B46A", "MainCourtyardsBuilding")
   graph.add_edge("MainCourtyardsBuilding", "B46C")
   graph.add_edge("B46B", "B46C")
   graph.add_edge("B46B", "LeaseOffice")
   graph.add_edge("B46C", "LeaseOffice")
   graph.add_edge("B46A", "LeaseOffice")
   graph.add_edge("B46D", "B46B")
   graph.add_edge("B46D", "LeaseOffice")
   graph.add_edge("B46D", "B46E")
   graph.add_edge("B46F", "B46C")
   graph.add_edge("B46F", "B46G")
   graph.add_edge("B46F", "LeaseOffice")
   graph.add_edge("B46G", "LeaseOffice")
   graph.add_edge("B46G", "B46D")
